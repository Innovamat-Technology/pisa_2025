...
ROOT = Path(os.environ.get("PISA_REPO") or Path(__file__).resolve().parents[4]).resolve()
...
INTERIM = ROOT / "data" / "interim" / "python"
...
# Common additive link error, in score points, for mean changes from 2022 to 2025.
# Values recovered to three decimals from the published trend-table standard errors;
# they agree with Technical Report Table 15.A.20 at its two-decimal precision.
# Sources and reconstruction: reference/README.md.
LINK_ERROR_2022_2025 = {"math": 1.220, "read": 1.094, "scie": 3.116}
