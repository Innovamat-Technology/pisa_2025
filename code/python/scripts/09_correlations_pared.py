...
Usage: python code/python/scripts/09_correlations_pared.py [math|read|scie]"""
import sys
...
rows = []
for tag, (H, P, M) in (("published", ("hisei", "paredint", "homepos")), ("harmonized", ("hisei_h", "pared_h", "homepos_h"))):
